...
// Second Homework Bulletpoint
const webAndEmail = [];
userData.forEach(id => {
  let info = `Website: ${id.website}: Email: ${id.email}`;
  webAndEmail.push(info);
});
